...
The challenge was to add shading to the 3D models and render them on a canvas with the minimum lines of code possible ( _curently it is in the 300 lines range!_ *).
...
* Since I added 3D Studio files support, the code lines count is now around 500.